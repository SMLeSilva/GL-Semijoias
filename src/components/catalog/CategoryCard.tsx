...
export const CategoryCard: React.FC<CategoryCardProps> = ({ category, index }) => {
  ...
  return (
    <div className="group bg-white rounded-2xl border border-neutral-100 shadow-sm hover:shadow-xl transition-luxury overflow-hidden my-6">
      <div
      ...
      >
        ...
        <div className="flex-1 p-6 sm:p-8 lg:p-10 flex flex-col justify-between bg-white z-10">
          <div>
            <h3 className="font-serif text-2xl sm:text-3xl lg:text-4xl font-bold text-black tracking-tight leading-tight">
              {category.name}
            </h3>
            <p className="mt-3 text-neutral-600 text-sm sm:text-base leading-relaxed max-w-xl">
        ...
        <div className="lg:w-2/5 relative min-h-[240px] lg:min-h-full image-zoom-container bg-neutral-100 overflow-hidden">
          <Image
